...
module Kilo::SessionTemplates
  UPPER_BODY = {
    "overhead_press" => {
      name: "Overhead Press",
      slots: [
        { position: "A1", category: "primary_press", default_exercise: "Press - Seated - BB - Medium Grip", sets: "4-6", reps: "1-12", tempo: "4-0-X-0", rest: 120 },
        ...
        { position: "C1", category: "triceps", default_exercise: "Triceps Extension - Flat - EZ Bar - Close Grip - Semi-Pronated", sets: "2-3", reps: "10-15", tempo: "3-0-1-0", rest: 30 },
        { position: "C2", category: "biceps", default_exercise: "Curl - Scott - EZ Bar - Close Grip - Semi-Pronated", sets: "2-3", reps: "10-15", tempo: "3-0-1-0", rest: 30 }
      ]
    },
    "incline_press" => {
      name: "Incline Press",
      slots: [
        { position: "A1", category: "primary_press", default_exercise: "Press - 35° Incline - DB", sets: "4-6", reps: "1-12", tempo: "4-0-X-0", rest: 120 },
    ...
    "bench_press" => {
      ...
      slots: [
        ...
        { position: "C1", category: "external_rotation", default_exercise: "External Rotation - Side Lying - DB - One-Arm", sets: "2-3", reps: "10-15", tempo: "3-0-1-0", rest: 30 },
        { position: "C2", category: "scapular_retraction", default_exercise: "Trap 3 - Prone - 45° Incline - DB", sets: "2-3", reps: "10-15", tempo: "3-0-1-0", rest: 30 }
      ]
    },
    "dip" => {
      name: "Dip",
      slots: [
        ...
        { position: "B1", category: "assistance_press", default_exercise: "Press - 15° Decline - DB", sets: "3-4", reps: "6-10", tempo: "3-0-1-0", rest: 60 },
        { position: "B2", category: "assistance_pull", default_exercise: "Row - Bent-Over - DB - Neutral", sets: "3-4", reps: "6-10", tempo: "3-0-1-0", rest: 60 },
        { position: "C1", category: "external_rotation", default_exercise: "External Rotation - Side Lying - DB - One-Arm", sets: "2-3", reps: "10-15", tempo: "3-0-1-0", rest: 30 },
        { position: "C2", category: "scapular_retraction", default_exercise: "Trap 3 - Prone - 45° Incline - DB", sets: "2-3", reps: "10-15", tempo: "3-0-1-0", rest: 30 }
      ]
  ...
  LOWER_BODY = {
    "squat_1" => {
      name: "Squat 1",
      slots: [
        { position: "A", category: "primary_squat", default_exercise: "Squat - Heels Elevated - BB", sets: "4-6", reps: "1-12", tempo: "4-0-X-0", rest: 240 },
        { position: "B1", category: "split_stance", default_exercise: "Split Squat - Front Foot Elevated - DB", sets: "3-4", reps: "6-12", tempo: "3-0-1-0", rest: 60 },
        { position: "B2", category: "knee_flexion", default_exercise: "Leg Curl - Lying - Feet Neutral - Dorsiflexed", sets: "3-4", reps: "6-12", tempo: "3-0-1-0", rest: 60 },
        { position: "C1", category: "knee_extension", default_exercise: "Leg Press - Narrow Stance", sets: "2-3", reps: "10-20", tempo: "3-0-1-0", rest: 30 },
        { position: "C2", category: "hip_extension", default_exercise: "Back Extension - Horizontal", sets: "2-3", reps: "10-20", tempo: "3-0-1-0", rest: 30 }
      ]
    },
    "squat_2" => {
      name: "Squat 2",
    ...
    "front_squat" => {
      ...
      slots: [
        ...
        { position: "B", category: "specialty_deadlift", default_exercise: "Deadlift - Rack - Mid Thigh - Wide Grip", sets: "4-5", reps: "6-12", tempo: "3-0-1-0", rest: 180 },
        { position: "C1", category: "calves", default_exercise: "Calf Raise - Seated - Machine", sets: "2-3", reps: "10-20", tempo: "3-0-1-0", rest: 30 },
        { position: "C2", category: "abdominal", default_exercise: "Crunch - Supine", sets: "2-3", reps: "10-20", tempo: "3-0-1-0", rest: 30 }
      ]
    },
    "deadlift" => {
      name: "Deadlift",
      slots: [
        { position: "A", category: "primary_deadlift", default_exercise: "Deadlift - Trap Bar - High Handles", sets: "4-6", reps: "1-6", tempo: "4-1-X-0", rest: 240 },
        { position: "B1", category: "split_stance", default_exercise: "Split Squat - Front Foot Elevated - DB", sets: "3-4", reps: "6-12", tempo: "3-0-1-0", rest: 60 },
        { position: "B2", category: "knee_flexion", default_exercise: "Leg Curl - Lying - Feet Neutral - Dorsiflexed", sets: "3-4", reps: "6-12", tempo: "3-0-1-0", rest: 60 },
        { position: "C1", category: "calves", default_exercise: "Calf Raise - Seated - Machine", sets: "2-3", reps: "10-20", tempo: "3-0-1-0", rest: 30 },
        { position: "C2", category: "abdominal", default_exercise: "Crunch - Supine", sets: "2-3", reps: "10-20", tempo: "3-0-1-0", rest: 30 }
  ...
  FULL_BODY = {
    "squat_1_overhead_press" => {
      ...
      slots: [
        { position: "A", category: "primary_squat", default_exercise: "Squat - Heels Elevated - BB", sets: "3-4", reps: "1-12", tempo: "4-0-X-0", rest: 240 },
        { position: "B1", category: "primary_press", default_exercise: "Press - Seated - BB - Medium Grip", sets: "3-4", reps: "1-12", tempo: "4-0-X-0", rest: 120 },
        ...
        { position: "C1", category: "split_stance", default_exercise: "Split Squat - Front Foot Elevated - DB", sets: "2-3", reps: "6-12", tempo: "3-0-1-0", rest: 60 },
        { position: "C2", category: "knee_flexion", default_exercise: "Leg Curl - Lying - Feet Neutral - Dorsiflexed", sets: "2-3", reps: "6-12", tempo: "3-0-1-0", rest: 60 },
    ...
    "front_squat_incline_press" => {
      ...
      slots: [
        ...
        { position: "B1", category: "primary_press", default_exercise: "Press - 35° Incline - DB", sets: "3-4", reps: "1-12", tempo: "4-0-X-0", rest: 120 },
        { position: "B2", category: "primary_pull", default_exercise: "Chin-Up - Medium Grip - Neutral", sets: "3-4", reps: "1-12", tempo: "4-0-X-0", rest: 120 },
        { position: "C", category: "specialty_deadlift", default_exercise: "Deadlift - Rack - Mid Thigh - Wide Grip", sets: "3-4", reps: "6-12", tempo: "3-0-1-0", rest: 180 },
    ...
    "deadlift_dip" => {
      name: "Deadlift & Dip",
      slots: [
        { position: "A", category: "primary_deadlift", default_exercise: "Deadlift - Trap Bar - High Handles", sets: "3-4", reps: "1-6", tempo: "4-1-X-0", rest: 240 },
        ...
        { position: "C1", category: "split_stance", default_exercise: "Split Squat - Front Foot Elevated - DB", sets: "2-3", reps: "6-12", tempo: "3-0-1-0", rest: 60 },
        { position: "C2", category: "knee_flexion", default_exercise: "Leg Curl - Lying - Feet Neutral - Dorsiflexed", sets: "2-3", reps: "6-12", tempo: "3-0-1-0", rest: 60 },
        { position: "D1", category: "assistance_press", default_exercise: "Press - 15° Decline - DB", sets: "2-3", reps: "6-10", tempo: "3-0-1-0", rest: 60 },
        { position: "D2", category: "assistance_pull", default_exercise: "Row - Bent-Over - DB - Neutral", sets: "2-3", reps: "6-10", tempo: "3-0-1-0", rest: 60 }
      ]
    }
  }.freeze
  ...
  BODY_PART = {
    ...
    "lower_body" => {
      ...
      training_method: "triset",
      slots: [
        { position: "A1", group: "A", group_type: "triset", category: "primary_squat", default_exercise: "Squat - Heels Elevated - BB", sets: "4", reps: "8", tempo: "4-0-1-0", rest: 10 },
    ...
    "back_and_shoulders" => {
      ...
      slots: [
        ...
        { position: "B1", group: "B", group_type: "post_exhaustion", category: "shoulders", default_exercise: "Trap 3 - Prone - 15° Incline - DB", sets: "4", reps: "15", tempo: "2-0-1-0", rest: 60 },
